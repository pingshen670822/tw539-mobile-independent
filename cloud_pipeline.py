...
def build_site(latest, changed, previous=None):
    ...
    if settlement:
        ...
        settlement['rolling_adjustment']={
            ...
            'direct_hit_front5_blend':(current.get('rolling_weight_adjustment') or {}).get('direct_hit_front5_blend'),
    ...
    health={
        ...
        'direct_hit_front5_blend':backtest.get('direct_hit_front5_blend'),
