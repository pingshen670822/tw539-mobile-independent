...
checks={
    ...
    ROOT/'report_pages.py':['PAGE_NAMES','本期最強1顆','最強號碼多邏輯總結','強烈推薦守門','本期分級主選','2中1～2','3中1～3','5中2～3','9中3～5','最後360期隔離回測','最新一期命中結算','開獎前封存實戰紀錄','正式方向模型','鐵律守門','開獎後更新與自主修復','def render_report_pages'],
