...
checks={
    ...
    ROOT/'.github/workflows/watchdog.yml':['watchdog.py','auto-update.yml','repair=true','timeout-minutes: 25','timeout-minutes: 17','30,35,40,45,50,55 12','*/5 13-16','actions: write','actions/checkout@v7','actions/setup-python@v7'],
    ROOT/'watchdog.py':['PUBLIC_FETCH_RETRY_DELAYS=(0,2,6)','PUBLIC_FETCH_TIMEOUT_SECONDS=25','def fetch_public','tw539-mobile-ironlaw-v7','AbortController','SYNC_TIMEOUT_MS=10000','syncInFlight','system-health.json','published-settlements.jsonl','full_history_mode','latest_period','開獎後兩小時官方資料仍未取得','自主修復欄位','三十組方向模型、三百六十期選擇窗與五組權重共識','第10至15名偏移檢查','REPORT_PAGES','本期預測頁混入其他分類資料','開獎檢討分頁內容不完整'],
}
